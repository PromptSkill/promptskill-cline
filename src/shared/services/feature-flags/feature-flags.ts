...
const promptSkillNativeToolCallsEnabled = process.env.PROMPTSKILL_CLINE_NATIVE_TOOL_CALLS_ENABLED === "true"
const promptSkillOpenAiNativeResponseApiEnabled =
	process.env.PROMPTSKILL_CLINE_OPENAI_NATIVE_RESPONSE_API_ENABLED === "true"
...
export const FeatureFlagDefaultValue: Partial<Record<FeatureFlag, FeatureFlagPayload>> = {
	...
	[FeatureFlag.NATIVE_TOOL_CALLS_NEXT_GEN_MODELS]: promptSkillNativeToolCallsEnabled,
	[FeatureFlag.ONBOARDING_MODELS]: process.env.E2E_TEST === "true" ? { models: {} } : undefined,
	[FeatureFlag.OPENAI_NATIVE_RESPONSE_API]: promptSkillOpenAiNativeResponseApiEnabled,
}
