...
export function buildApiHandler(configuration: ApiConfiguration, mode: Mode): ApiHandler {
	...
	// PromptSkill: candidate workspaces always route through the native OpenAI-compatible provider,
	// which is the path that supports PromptSkill's required-tool and Responses API behavior.
	const apiProvider: string = promptSkillApiProviderForMode(mode)
