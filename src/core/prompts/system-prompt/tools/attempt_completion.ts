...
// PromptSkill: upstream supports an optional command parameter here, but candidate workspaces already manage
// app preview/dev server access, and post-completion commands can unnecessarily repeat verification work after the task appears done.
