...
const GENERIC: ClineToolSpec = {
	...
	name: "write_to_file",
	description:
		"Request to write content to a file at the specified path. Use this for new files, or for existing files only when the change is broad enough that targeted SEARCH/REPLACE edits would be more error-prone. If the file exists, it will be overwritten with the provided content. If the file doesn't exist, it will be created. This tool will automatically create any directories needed to write the file.",
	parameters: [
		{
			name: "path",
			required: true,
...
const NATIVE_NEXT_GEN: ClineToolSpec = {
	...
	name: "write_to_file",
	description:
		"[IMPORTANT: Always output the absolutePath first] Request to write content to a file at the specified path. Use this for new files, or for existing files only when the change is broad enough that targeted SEARCH/REPLACE edits would be more error-prone. If the file exists, it will be overwritten with the provided content. If the file doesn't exist, it will be created. This tool will automatically create any directories needed to write the file.",
	parameters: [
		{
			name: "absolutePath",
			required: true,
