...
export class FeatureFlagsService {
	...
	public getNativeToolCallEnabled(): boolean {
		return (
			this.getBooleanFlagEnabled(FeatureFlag.NATIVE_TOOL_CALLS_NEXT_GEN_MODELS) ||
			process.env.PROMPTSKILL_CLINE_NATIVE_TOOL_CALLS_ENABLED === "true"
		)
	}

	public isResponseApiEnabled(): boolean {
		return (
			this.getBooleanFlagEnabled(FeatureFlag.OPENAI_NATIVE_RESPONSE_API) ||
